...
import ManagerFilterationTickets from './ManagerFilterationTickets';
        ...
        <div className='col-md-8'>
          <div className='row'>
            <div className='col-md-12 d-flex align-items-center' style={{ gap: '20px 20px' }}>
              ...
              >
                ...
                <Typography variant='subtitle1' sx={{ fontSize: '19px' }} className='fw-semibold'>
                  Re-open {tickets.reopen}/{tickets.total}
                </Typography>
              </div>
            </div>
          </div>
          <div className='row'>
            <div className='col-12'>
              <ManagerFilterationTickets datas={filterationData} />
            </div>
          </div>
        </div>

        <div className='col-md-4'>
          <Piechart datas={filterationData} />
        </div>
      </div>
    </div>
  );
