...
function SeniorManagerReviewTickets() {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                ...
                let filtered = getUsers.data.data.filter(
                    (data) => currentUserDatas.managedDepartments.includes(data.department)
                );
                setAssignUsers(filtered);
                console.log(filtered);
                console.log(currentUserDatas.managedDepartments);
            } catch (error) {
...
export default SeniorManagerReviewTickets