...
function CameraStructure() {
  ...
  return (
    <div className="container my-4 py-3">
      <BasicBreadcrumbs name={'Camera Structure'} />
      <Typography variant='h6' className='mb-3'>Camera Structure</Typography>
      <div className="row">
...
export default CameraStructure