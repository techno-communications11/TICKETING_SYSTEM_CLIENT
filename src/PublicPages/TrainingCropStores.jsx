...
import { Box, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Checkbox, Typography, Pagination, TextField, InputAdornment, IconButton } from '@mui/material';
...
function TrainingCropStores() {
  ...
  return (
    <div className="container my-4 py-3">
      <BasicBreadcrumbs name={'Training Crop Stores'} />
      <Typography variant='h6' className='mb-3'>Training Crop Stores</Typography>
      <div className="row">
...
export default TrainingCropStores