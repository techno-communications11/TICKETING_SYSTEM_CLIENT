...
function AddTicketProblemCategory({ fetchCategory }) {
  ...
  const handleAddCategory = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/pcategory/addproblemcateroy', {
        name: newCategory,
  ...
  return (
    <div>
      <IconButton color="primary" aria-label="add" onClick={() => setShowCategoryModal(true)}>
        <AddIcon />
      </IconButton>
...
export default AddTicketProblemCategory;
