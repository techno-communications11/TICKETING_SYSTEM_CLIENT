    ...
    const fetchAllTickets = useCallback(async () => {
        ...
        try {
            let filtered = filterationsData?.filter(
                (data) =>
                    (
                        (data.department === department && data.subDepartment === subDepartment) ||
                        data.managerID === id ||
                        data.userId === id ||
                        (data.assignerId === id && data.approved === true)
                    ) &&
                    data.status === "pending"
            );
            setTickets(filtered);
...
export default AgentPendingTickets