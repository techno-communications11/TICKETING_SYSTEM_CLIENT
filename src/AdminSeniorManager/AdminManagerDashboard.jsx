...
import AdminManagerFilterationTickets from './AdminManagerFilterationTickets';
    ...
    const fetchTickets = useCallback(async () => {
        try {
            ...
            let filtered = response.data.data.filter(
                (data) =>
                    data.senior_managers === "Admin Manager"
            );
            // Apply filters
        ...
        <div className='container'>
            ...
            <div className='row'>
                ...
                <div className='col-md-8'>
                    <div className='row'>
                        <div className='col-md-12 d-flex align-items-center' style={{ gap: '20px 20px' }}>
                            <div
                                ...
                                onClick={() => { navigate('/admin-manager-review-open-ticket'); setFilterationsData(filterationData) }}
                            >
                            ...
                            <div
                                ...
                                onClick={() => { navigate('/admin-manager-review-close-ticket'); setFilterationsData(filterationData) }}
                            >
                                <Typography variant='h2' sx={{ fontSize: '35px' }} className='fw-bold' color='#6f2da8'>
                                    {tickets.closed}
                                </Typography>
                  ...
                  onClick={() => [navigate('/admin-manager-review-complete-ticket')]}
                >
                  <Typography variant='h2' sx={{ fontSize: '35px' }} className='fw-bold' color='#6f2da8'>
                    {tickets.complete}
                  </Typography>
                  <Typography variant='subtitle1' sx={{ fontSize: '19px' }} className='fw-semibold'>
                    Complete
                            ...
                            <div
                                ...
                                onClick={() => { navigate('/admin-manager-review-pending-ticket'); setFilterationsData(filterationData) }}
                            >
                                <Typography variant='h2' sx={{ fontSize: '35px' }} className='fw-bold' color='#6f2da8'>
                                    {tickets.Pending}
                                </Typography>
                            ...
                            <div
                                ...
                                onClick={() => { navigate('/admin-manager-review-reopen-ticket'); setFilterationsData(filterationData) }}
                            >
                                <Typography variant='h2' sx={{ fontSize: '35px' }} className='fw-bold' color='#6f2da8'>
                                    {tickets.reopen}
                                </Typography>
                    ...
                    <div className='row'>
                        <div className='col-12'>
                            <AdminManagerFilterationTickets datas={filterationData} />
                        </div>
                    </div>
                </div>

                <div className='col-md-4'>
                    <AdminManagerPiechart datas={filterationData} />
                </div>
            </div>
        </div>
    );
