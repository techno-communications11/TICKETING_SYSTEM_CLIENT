...
function AdminManagerManageTickets() {
    ...
    const fetchTickets = useCallback(async () => {
        ...
        try {
            ...
            const filtered = response?.data?.data?.filter(ticket =>
                ticket.senior_managers === "Admin Manager"
            );
    ...
    const handleReviewTicket = (id) => {
        navigate(`/admin-manager-review-ticket/${id}`);
    };
        ...
        <div className="container">
            <div className="row">
                <div className="col-md-12 d-flex justify-content-between align-items-center py-3 bg-white">
                    ...
                    <AdminManagerCreateTickets fetchTickets={fetchTickets} />
                </div>
            </div>
...
export default AdminManagerManageTickets