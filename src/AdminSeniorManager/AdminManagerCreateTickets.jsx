...
import AdminManagerCreateTicketBttn from './AdminManagerCreateTicketBttn';
const style = {
    position: 'absolute',
    top: '50%',
    left: '50%',
...
function AdminManagerCreateTickets({ fetchTickets }) {
        ...
        <div>
            ...
            >
                <Box sx={style}>
                    ...
                    >
                        <AdminManagerCreateTicketBttn handleClose={handleClose} fetchTickets={fetchTickets} />
                    </Box>
                </Box>
            </Modal>
        </div>
...
export default AdminManagerCreateTickets