...
function AdminManagerReviewTickets({ fetchTickets }) {
    ...
    useEffect(() => {
        ...
        const fetchUsers = async () => {
            try {
                ...
                const filteredUser = getUsers.data.data.filter((data) => data.department === "Admin" && data.subDepartment === "Manager");
...
export default AdminManagerReviewTickets